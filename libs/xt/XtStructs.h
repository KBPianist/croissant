...
namespace xti
{
    ...
    */
    struct XT_API_EXPORT COrderInfo
    {
        ...
        char                            m_strMarket[32];            ///< 市场  仅三方算法指令有值
        char                            m_strInstrument[32];        ///< 合约  仅三方算法指令有值
        char                            m_strOrderType[32];         ///< 算法名称  仅三方算法指令有值
        double                          m_dPrice;                   ///< 基准价  仅三方算法指令有值
        int                             m_nVolume;                  ///< 下单总量  仅三方算法指令有值
        int                             m_nValidTimeStart;          ///< 有效开始时间  仅三方算法指令有值
        int                             m_nValidTimeEnd;            ///< 有效结束时间  仅三方算法指令有值
        double                          m_dMaxPartRate;             ///< 量比比例  仅三方算法指令有值
        double                          m_dMinAmountPerOrder;       ///< 委托最小金额  仅三方算法指令有值
        EOperationType                  m_eOperationType;           ///< 下单操作：买入卖出  仅三方算法指令有值
        EStopTradeForOwnHiLow           m_nStopTradeForOwnHiLow;    ///< 涨跌停控制  仅三方算法指令有值
        char                            m_strAccountKey[64];        ///< 账号key
    };
    ...
    struct XT_API_EXPORT CIntelligentAlgorithmOrder
    {
        ...
        char                    m_strMarket[32];                ///< 市场
        char                    m_strInstrument[32];            ///< 合约
        char                    m_strOrderType[32];             ///< 算法名称，VWAP，TWAP，VP，PINLINE，FLOAT
        double                  m_dPrice;                       ///< 基准价
        int                     m_nVolume;                      ///< 下单总量
        ...
        int                     m_nMaxTradeDurationAfterET;     ///< 收盘后继续执行的秒数
    ...
    struct XT_API_EXPORT CGroupOrder
    {
        ...
        EOperationType    m_eOperationType[500];     ///< 每只股票的下单类型
    ...
    struct XT_API_EXPORT CInstrumentDetail
    {
        ...
        EXtSuspendedType m_nSuspendedType;      ///< 停牌状态
